...
Wait = {
    ...
    "Unban":False,
    "Admin": {
        "ua797021910f0584e11be56d4a6fa74ed":True #MID ADMIN
    },
}
                        ...
                        if dpkText.lower() == '_PYTHON3_':
                            ...
                            if user in DpkFamily or user in Wait["Admin"]:
                                ...
                                if txt[1] == "on":
                                    if jmlh <= 1000:
                                       ...
                                       cl.sendText(kirim, "Maksimal 1000 SpamTeks!")
                                elif txt[1] == "off":
                                    if jmlh <= 1000:
                          ...
                          if user in DpkFamily or user in Wait["Admin"]:
                            ...
                            if user in DpkFamily or user in Wait["Admin"]:
                                ...
                                opn = " "+waktu(eltime)
                                cl.sendText(kirim,"Connect to Boy-FirA\nBot Active\n" + opn)                
